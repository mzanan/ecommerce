...
interface SetEditPageClientContentProps {
    set: SetRow & { set_images: SetImageRow[] };
    setId: string;
    initialAssociatedProducts: ProductWithPosition[];
}

export default function SetEditPageClientContent({ set, setId, initialAssociatedProducts }: SetEditPageClientContentProps) {
    useEffect(() => {
